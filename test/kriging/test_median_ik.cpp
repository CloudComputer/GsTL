...
int main() {
  ...
  neighborhood voisin2 = voisin;
 
  std::vector<neighborhood> neighbors;
  neighbors.push_back( voisin );
  neighbors.push_back( voisin2 );
  ...
  typedef std::vector<neighborhood>::iterator NeighIterator;
  ...
  typedef MedianIK_cdf_estimator<CoKrigingConstraints,
                                 CoKrigingCombiner,
                                 My_covariance_set > CdfEstimator; 

  My_covariance_set covar;
  std::vector< CoKrigingCombiner > combiners(2);
